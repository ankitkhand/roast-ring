...
export const contentPages: Record<ContentSlug, ContentPageDefinition> = {
  "yo-mama-jokes": {
    slug: "yo-mama-jokes",
    title: `Yo Mama Jokes: Funny, Savage & Classic Roasts | ${siteConfig.name}`,
    h1: "Yo Mama Jokes",
  ...
  "best-yo-mama-jokes": {
    ...
    title: `Best Yo Mama Jokes: ${siteConfig.name} Hall of Fame`,
    h1: "The Best Yo Mama Jokes",
    description: `A tightly curated Hall of Fame featuring 60 of ${siteConfig.name}’s strongest classic, modern, clever and battle-ready Yo Mama jokes.`,
    eyebrow: `${siteConfig.name.toUpperCase()} HALL OF FAME`,
  ...
  "funny-yo-mama-jokes": {
    ...
    title: `Funny Yo Mama Jokes That Actually Land | ${siteConfig.name}`,
  ...
  "savage-yo-mama-jokes": {
    ...
    title: `Savage Yo Mama Jokes for a Proper Roast | ${siteConfig.name}`,
  ...
  "yo-mama-roasts": {
    slug: "yo-mama-roasts",
    title: `Yo Mama Roasts: Lines, Comebacks & How to Win a Roast Battle | ${siteConfig.name}`,
    h1: "Yo Mama Roasts",
